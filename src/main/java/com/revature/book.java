...
public class book {
    ...
    {   Scanner sc = new Scanner(System.in);
        ...
        {   System.out.println("WARNING! New Integral uploaded to database will not have a ");
            System.out.println("Calculator method associated with it. Do you still wish to upload ");
        ...
        {   System.out.println("This app is an integral database used to view solutions to integrals that have been");
            ...
            System.out.println("to the database, press 5. Note that a warning will pop up stating that this new integral ");
            System.out.println("will not have a calculator method established for it upon inserting it. To learn how to use"); 
            System.out.println("this app, press 6. To read author's ");
